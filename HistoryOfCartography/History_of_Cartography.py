...
##
##PDFs = []
##Volume1PDFs = glob.glob(Desktop + os.sep + folder + os.sep + '*.pdf')
##for pdf in Volume1PDFs:
##    PDFs.append(pdf)
####PDFs.sort()
##for x in PDFs:
...
##    href = item.find('a')
##    pdfURL = href.get('href')
##    Vol1_URL_List.append(url[:-12] + pdfURL)
##
##    title = item.get_text()
##    Vol1_Titles.append(title)
...
##i=1
##for x in Vol1_URL_List:
##    urllib.urlretrieve(x, Desktop + os.sep + folder + os.sep + str(i) + '.pdf')
##    i+=1
##
##Vol1_FinalPDF = Desktop + os.sep + folder + os.sep + 'History_of_Cartography_Vol1.pdf'
##
##finalPDF = arcpy.mapping.PDFDocumentCreate(Vol1_FinalPDF) 
##
##Volume1PDFs = glob.glob(Desktop + os.sep + folder + os.sep + '*.pdf')
